namespace NWCSampleManager.Migrations
{
    using System;
    ...
    public partial class addurl : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.QuestionID, t.CorequisiteID })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.QuestionID, t.PostrequisiteID })
                .ForeignKey("dbo.Questions", t => t.QuestionID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.QuestionID, t.PrerequisiteID })
                .ForeignKey("dbo.Questions", t => t.QuestionID)
